...
test.describe('Not Found page', () => {
  test('unknown route renders the 404 page and "Back to Home" recovers to the landing page', async ({ page }) => {
    ...
    await expect(
      page.getByRole('heading', { name: 'Welcome to SampleApp', level: 1 })
    ).toBeVisible();
  });
});
