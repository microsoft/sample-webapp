...
/**
 * NotFound page (catch-all `*` route) end-to-end coverage.
 *
 * Any unmatched route renders NotFound.js: a container with
 * data-testid="not-found-page", a "404" level-1 heading, a "Page Not Found"
 * level-2 heading, and a "Back to Home" link that routes back to /.
 */
