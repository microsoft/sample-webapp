...
test.describe('Home page', () => {
  test('should render the welcome heading, intro description, and all call-to-action links', async ({ page }) => {
    ...
    // The intro description paragraph is the element PR #292 edits — assert its
    // rendered text so a revert or regression of the content variant fails.
    ...
    await expect(description).toContainText(
      'Feature branch users/dev131 adds a homepage content variant.'
    );
