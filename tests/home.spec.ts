...
test.describe('Home page', () => {
  test('should render the welcome heading and all call-to-action links', async ({ page }) => {
    ...
    // The description paragraph carries the homepage messaging (PR #95 content variant).
    await expect(page.locator('#description')).toHaveText(
      'A React web application built for Playwright testing. Feature branch users/dev13 adds a homepage content variant.'
    );
