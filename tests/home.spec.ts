...
test.describe('Home page', () => {
  test('should render the welcome heading and all call-to-action links', async ({ page }) => {
    ...
    // The intro description carries this feature branch's content variant.
    await expect(page.locator('#description')).toHaveText(
      'A React web application built for Playwright testing. Feature branch users/dev39 adds a homepage content variant.'
    );
