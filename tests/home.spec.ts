...
test.describe('Home page', () => {
  test('should render the welcome heading and all call-to-action links', async ({ page }) => {
    ...
    // The homepage description paragraph carries the intended marketing copy.
    await expect(page.locator('#description')).toHaveText(
      'A React web application built for Playwright testing. Feature branch users/dev92 adds a homepage content variant.'
    );
  });
