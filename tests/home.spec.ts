...
test.describe('Home page', () => {
  test('should render the welcome heading, intro description, and all call-to-action links', async ({ page }) => {
    ...
    // The intro description paragraph (#description) is the element this change edits;
    // assert it renders the base blurb plus the content-variant sentence the change adds.
    ...
    await expect(description).toContainText(
      'Feature branch users/dev133 adds a homepage content variant.'
    );
