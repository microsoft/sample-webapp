...
23. **Home landing page renders the welcome heading and all call-to-action links** — `tests/home.spec.ts`
    ...
    - Step/Expectation Pairs:
      ...
      3. Step: Read the intro description paragraph (`#description`) rendered under the welcome heading
        Expectation: The `#description` paragraph displays the exact copy "A React web application built for Playwright testing. Feature branch users/dev37 adds a homepage content variant." (covers the homepage content variant added on branch users/dev37)
