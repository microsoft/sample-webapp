...
23. **Home landing page renders the welcome heading and all call-to-action links** — `tests/home.spec.ts`
    ...
    - Step/Expectation Pairs:
      ...
      3. Step: Inspect the intro description paragraph (`#description`) [attribution: change — PR #156 homepage content variant]
        Expectation: The `#description` paragraph is visible and contains the content-variant copy "Feature branch users/dev47 adds a homepage content variant."
