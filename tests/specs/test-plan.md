...
23. **Home landing page renders the welcome heading, intro description, and all call-to-action links** — `tests/home.spec.ts`
    ...
    - Step/Expectation Pairs:
      ...
      2. Step: Inspect the intro description paragraph (`#description`)
        Expectation: The description paragraph is visible and its text contains the homepage content-variant copy — "A React web application built for Playwright testing. Feature branch users/dev136 adds a homepage content variant."
