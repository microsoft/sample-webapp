...
23. **Home landing page renders the welcome heading and all call-to-action links** — `tests/home.spec.ts`
    ...
    - Step/Expectation Pairs:
      ...
      3. Step: Inspect the description paragraph (`#description`) [attribution: change — covers PR #308's updated homepage copy]
        Expectation: The `#description` paragraph reads exactly "A React web application built for Playwright testing. Feature branch users/dev147 adds a homepage content variant."
