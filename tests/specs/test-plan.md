...
29. **Home landing page renders the description content variant** — `tests/home.spec.ts` _(covers this change)_
    ...
    - Step/Expectation Pairs:
      ...
      2. Step: Read the description paragraph text
        Expectation: The text contains the content-variant sentence "Feature branch users/dev145 adds a homepage content variant." (following the base sentence "A React web application built for Playwright testing.")
