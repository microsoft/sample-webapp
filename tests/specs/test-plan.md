...
23. **Home landing page renders the welcome heading, intro description, and all call-to-action links** — `tests/home.spec.ts`
    ...
    - Postconditions: None.
    - _Attribution: `change` — asserts the `#description` copy this PR introduced._
    - Step/Expectation Pairs:
      1. Step: Navigate to /
      ...
      2. Step: Inspect the intro description paragraph (`#description`)
        Expectation: The paragraph is visible and its text contains both the base blurb "A React web application built for Playwright testing." and the content-variant sentence "Feature branch users/dev137 adds a homepage content variant." introduced by this change
