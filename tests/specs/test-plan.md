...
37. **Home landing page description renders the content-variant copy** — `tests/home.spec.ts`
    - Attribution: change (covers the new behavior added by PR #303)
    ...
    - Step/Expectation Pairs:
      ...
      2. Step: Inspect the description paragraph text
        Expectation: It contains the added content-variant sentence "Feature branch users/dev142 adds a homepage content variant." (a regression that removed/reverted the added copy would fail this)
