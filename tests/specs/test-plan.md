...
23. **Home landing page renders the welcome heading, intro description, and all call-to-action links** — `tests/home.spec.ts`
    ...
    - Step/Expectation Pairs:
      ...
      3. Step: Inspect the intro description paragraph (`#description`)
        Expectation: The description paragraph is visible and contains the homepage messaging, including the content-variant text "Feature branch users/dev79 adds a homepage content variant" (covers the PR #213 homepage content update)
