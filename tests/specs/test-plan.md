...
### Home
23. **Home landing page renders the welcome heading, tagline, and all call-to-action links** — `tests/home.spec.ts`
    ...
    - Step/Expectation Pairs:
      ...
      2. Step: Inspect the tagline paragraph directly below the welcome heading in the main content
        Expectation: The tagline text "Trusted by over 10,000 developers worldwide." is visible within the main content (PR #374's added copy — asserts the real rendered text so a removed or reworded tagline is caught)
