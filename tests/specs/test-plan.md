...
23. **Home landing page renders the welcome heading and all call-to-action links** — `tests/home.spec.ts`
    ...
    - Step/Expectation Pairs:
      ...
      3. Step: Read the intro description paragraph (`#description`)
        Expectation: The description paragraph is visible and its text contains the homepage content-variant copy for this feature branch — "Feature branch users/dev141 adds a homepage content variant" [change]
