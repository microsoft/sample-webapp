...
23. **Home landing page renders the welcome heading and all call-to-action links** — `tests/home.spec.ts`
    ...
    - Step/Expectation Pairs:
      ...
      3. Step: Inspect the intro description paragraph (`#description`) in the main content
        Expectation: The `#description` paragraph is visible and its text contains the homepage variant copy "Feature branch users/dev5 adds a homepage content variant" (the descriptive content this feature branch renders on the landing page)
