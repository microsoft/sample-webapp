...
37. **Home landing page renders the description paragraph copy (feature-variant messaging)** — `tests/home.spec.ts`
    ...
    - Step/Expectation Pairs:
      1. Step: Navigate to /
        Expectation: The `#description` paragraph (`page.locator('#description')`) is visible and its text contains "Feature branch users/dev12 adds a homepage content variant." — the homepage messaging copy this change introduced
