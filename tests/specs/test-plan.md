...
23. **Home landing page renders the welcome heading, description, and all call-to-action links** — `tests/home.spec.ts`
    ...
    - Step/Expectation Pairs:
      ...
      2. Step: Inspect the intro description paragraph (`#description`)
        Expectation: The `#description` paragraph is visible and contains the homepage content-variant copy "Feature branch users/dev18 adds a homepage content variant." (the text this feature branch adds to the description)
