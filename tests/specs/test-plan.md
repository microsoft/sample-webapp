...
23. **Home landing page renders the welcome heading and all call-to-action links** — `tests/home.spec.ts`
    ...
    - Step/Expectation Pairs:
      ...
      3. Step: Inspect the intro description paragraph (`#description`)
        Expectation: The description paragraph is visible and its text includes the "Feature branch users/dev46 adds a homepage content variant." content variant introduced for this feature branch
