...
23. **Home landing page renders the welcome heading and all call-to-action links** — `tests/home.spec.ts`
    ...
    - Step/Expectation Pairs:
      ...
      3. Step: Read the homepage description paragraph (`#description`)
        Expectation: Its text is exactly "A React web application built for Playwright testing. Feature branch users/dev151 adds a homepage content variant." (the updated content-variant copy introduced by this change; origin: change)
